...
export default function OrderPanel({ selectedSymbol }: OrderPanelProps) {
  ...
  const spread = currentPrice
    ? (parseFloat(askPrice) - parseFloat(bidPrice)).toFixed(5)
    : "0";
  ...
  return (
    <div className="w-80 trading-bg-secondary trading-border border-l">
      ...
      <div className="p-4 space-y-4">
        ...
        <div>
          <Label htmlFor="volume" className="text-gray-400">
            Volume (Lots)
          </Label>
          <Input
            id="volume"
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            <Label htmlFor="stopLoss" className="text-gray-400">
              Stop Loss
            </Label>
            <Input
              id="stopLoss"
          ...
          <div>
            <Label htmlFor="takeProfit" className="text-gray-400">
              Take Profit
            </Label>
            <Input
              id="takeProfit"
        ...
        <Button
          ...
          disabled={
            placeOrderMutation.isPending || !volume || parseFloat(volume) <= 0
          }
