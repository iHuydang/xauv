...
router.put("/international-portfolio/holdings/:symbol/shares", (req, res) => {
  try {
    ...
    const updated = internationalPortfolioAccountManager.updateHoldingShares(
      symbol,
      shares,
    );
...
router.get("/international-portfolio/top-performers", (req, res) => {
  try {
    ...
    const topPerformers =
      internationalPortfolioAccountManager.getTopPerformers(count);
...
router.get("/international-portfolio/worst-performers", (req, res) => {
  try {
    ...
    const worstPerformers =
      internationalPortfolioAccountManager.getWorstPerformers(count);
...
router.get("/international-portfolio/diversification", (req, res) => {
  try {
    const metrics =
      internationalPortfolioAccountManager.getDiversificationMetrics();
...
router.post("/international-portfolio/holdings", (req, res) => {
  try {
    const { symbol, name, market, type, shares, currentPrice, currency } =
      req.body;
