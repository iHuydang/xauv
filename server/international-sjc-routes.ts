...
router.post('/international-sjc/create-80-orders', async (req, res) => {
  try {
    console.log('🚀 Creating 80 orders of 50 lots each for international SJC gold trading...');
    ...
    res.json({
      ...
      data: {
        ...
        physicalGoldCoordination: 'International institutions handling SJC gold sales'
      },
      message: 'Successfully created 80 orders with international SJC gold coordination'
    });
  } catch (error) {
  ...
  try {
    ...
    res.json({
      ...
      data: {
        ...
        physicalGoldTransfer: 'All international institutions coordinating SJC gold delivery',
        settlement: 'Complete international and Vietnamese settlement processed'
      },
...
router.post('/international-sjc/create-and-execute-80', async (req, res) => {
  try {
    ...
    const status = internationalSJCGoldSystem.getSystemStatus();
    const institutionSummary = internationalSJCGoldSystem.getInstitutionSummary();
    ...
    res.json({
      ...
      data: {
        ...
        internationalCoordination: {
          ...
          physicalGoldSales: 'International institutions selling SJC equivalent gold',
          vietnameseSettlement: 'Vietnamese banks and SJC handling profit/loss distribution',
          liquidityProviders: 'International institutions providing liquidity on user profits'
        },
        profitLossDistribution: {
          userProfits: 'Liquidity goes to international institutions + Gold market dilution',
          userLosses: 'Profits go to Vietnamese banks and SJC',
          physicalGoldTransfer: 'All orders include physical SJC gold coordination',
          internationalSettlement: 'Complete settlement with global institutions'
        }
      },
      message: 'Successfully created and executed 80 international SJC gold orders with physical delivery coordination'
    });
  } catch (error) {
  ...
  try {
    ...
    res.json({
      ...
      data: {
        ...
        coordination: 'Each institution handles physical SJC gold sales to Vietnamese market',
        liquidityProvision: 'International institutions provide liquidity on user profits',
        vietnameseSettlement: 'Vietnamese partners handle profit distribution when user loses'
      },
    ...
    if (success) {
      res.json({
        ...
        data: {
          orderId,
          status: 'executed',
          physicalGoldTransfer: 'International institution coordinating SJC gold delivery',
          profitDistribution: 'Processed according to user profit/loss outcome',
          internationalSettlement: 'Complete settlement with global and Vietnamese institutions'
        },
...
router.post('/international-sjc/convert-account', async (req, res) => {
  try {
    ...
    console.log(`🔑 Converting account ${accountId} to international physical SJC gold trading...`);
